...
//-Inserire nella 3° stringa la maggiore delle due precedenti.
...
do
{
    cout<<"Inserisci la prima stringa (max 10 caratteri), la seconda stringa (max 15 caratteri) e la terza (max 20 caratteri)"<<endl;
    gets(a);
    gets(b);
    gets(c);
